...
class asheis:
    ...
    def __init__(self, filename, ncpu='max', rebin=False):
        ...
        self.dict = {
            ...
            "si_10_258.38" :["si_10_258_375.1c.template.h5",0],
            ...
            "mg_5_276.58" : ["mg_05_276_579.1c.template.h5", 0],  
            "o_5_248.46" : ["o__05_248_456.1c.template.h5", 0],   
            "mg_6_268.98" : ["mg_06_268_986.1c.template.h5", 0],
            "o_6_184.11" : ["o__06_184_117.1c.template.h5", 0],
            "si_6_246.00" : ["si_06_246_004.2c.template.h5", 0],
            "si_7_275.37" :["si_07_275_368.3c.template.h5",0],
            "s_08_198.55" : ["s_08_198_55.1c.template.h5",0],
            "fe_14_274.20" : ["fe_14_274_203.1c.template.h5",0],
            "fe_16_251.06" : ["fe_16_251_061.1c.template.h5",0],
            "s_13_256.69" : ["s__13_256_686.1c.template.h5",0],
            "ca_14_183.46" : ["ca_14_183_457.1c.template.h5",0],
            "ar_14_187.96" : ["ar_14_187_964.1c.template.h5",0],
            "ar_14_191.04" : ["ar_14_191_404.2c.template.h5",0],
            "fe_12_196.64" : ["fe_12_196_640.2c.template.h5",0],
            "s_10_196.81" : ["s__10_196_814.3c.template.h5",0],
            "fe_13_196.525" : ["fe_13_196_525.2c.template.h5",0],
            "ar_11_194.10" : ["ar_11_194_104.6c.template.h5",0],
            "s_11_191.26" : ["s__11_191_264.2c.template.h5",0],
            "s_10_257.15" : ["s__10_257_147.4c.template",0],
    ...
    def get_intensity(self, line, outdir = os.getcwd(), refit=False, plot=True, mcmc=False, calib=2014):
        ...
        # Get the default component index from self.dict
        component_index = self.dict[f'{line}'][1]  

        # Check available components in the fit result
        available_components = fit_res.fit["component"][:]

        # Ensure component_index is valid
        if component_index not in available_components:
            print(f"WARNING: Default component {component_index} not found. Selecting the max available component.")
            component_index = max(available_components)  # Use highest available component

        print(f"DEBUG: Using component {component_index} for {line}")

        m = fit_res.get_map(component_index, measurement='intensity')
